...
- `Event Listener`인 `transitionend`가 연속으로 눌러질때 `class`명 삭제안되는 버그
- 참고 [Bug with transitionend event not correctly removing a CSS class](https://stackoverflow.com/questions/43966150/bug-with-transitionend-event-not-correctly-removing-a-css-class)
